    ...
    <div className="container mx-auto py-10 px-4 text-right">
      <Card className="max-w-2xl mx-auto bg-white/95 shadow-xl">
        <CardHeader className="text-center">
          <BarChart3 className="mx-auto h-16 w-16 text-app-gold mb-3" />
          <CardTitle className="text-3xl font-bold text-app-red">عرض تقارير الكميات</CardTitle>
          <CardDescription className="text-gray-600 mt-2 text-base">
            عرض التقارير المفصلة لكميات المواد المحسوبة لكل مشروع أو عنصر إنشائي.
          </CardDescription>
        </CardHeader>
